...
% \begin{subequations}
% \begin{align}
%     e^\mu(\lambda = \pm 1) &= \FourRowMat{E/m & 0 & 0 & \abs{\vv{p}}/m}{0 & 1 & 0 & 0}{0 & 0 & 1 & 0}{\abs{\vv{p}}/m & 0 & 0 & E/m} \invsqrtTo \FourRowMat{0}{\mp 1}{-i}{0} \\
%     e^\mu(\lambda = 0) &= \FourRowMat{E/m & 0 & 0 & \abs{\vv{p}}/m}{0 & 1 & 0 & 0}{0 & 0 & 1 & 0}{\abs{\vv{p}}/m & 0 & 0 & E/m} \FourRowMat{0}{0}{0}{1}
% \end{align}
% \end{subequations}
...
% Vi betragter polarisationstilstandene i \cref{eq:Opg1_Q3_PolarisationStatesInRestFrame} og booster ved brug af den inverse Lorentztransformation i \cref{eq:Opg1_A3_LorentzTransformation} til systemet, hvor partiklen bevæger sig med impuls $\vv{p}$ i $\zhat$-retningen.
% \begin{align}
%     e^\mu(\lambda = \pm 1) &= \FourRowMat{E/m & 0 & 0 & \abs{\vv{p}}/m}{0 & 1 & 0 & 0}{0 & 0 & 1 & 0}{\abs{\vv{p}}/m & 0 & 0 & E/m}
% \end{align}
