...
\end{align}
Varierer vi nu Lagrangedensiteten fås
\begin{align}
    \delta \L &= \pdif{\L}{\phi_{ij}} \delta \phi_{ij} + \pdif{\L}{\left( \partial_\mu \phi_{ij} \right)} \delta ( \partial_\mu \phi_{ij} ) \: ,
\end{align}
og indsætter vi dette i Euler-Lagrangeligningen og bruger Lagrangedensitetesns symmetri, så finder vi
\begin{align}
    0 &= \delta \L
...
\end{align}
Når det kommer til spørgsmålet symmetrier med den ortogonale gruppe $O(N)$ i \textbf{12)}, så vil vi i stedet for disse reelle matricer udvide symmetrien til gruppen af $N \times N$ unitære matricer, da disse også kan være komplekse, men stadig samme egenskab, nemlig
\begin{align}
