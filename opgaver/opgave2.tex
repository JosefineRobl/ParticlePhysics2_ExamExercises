...
\end{split}
\end{align}
hvor det er blevet benyttet, at transponering er ASSOCIATIV(?), altså $(B+C)^\intercal = B^\intercal + C^\intercal$ for to kvadratiske matricer $B$ og $C$, samt at $\abs{A_{ij}} \ll 1 \Rightarrow \abs{A_{ij}A_{ji}} \ll 1$ så $A^\intercal A$ dermed er så lille, at den negligeres.
